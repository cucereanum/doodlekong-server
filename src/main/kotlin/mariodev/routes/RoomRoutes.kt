...
import mariodev.data.models.BasicApiResponse
import mariodev.data.models.CreateRoomRequest
import mariodev.data.models.RoomResponse
import mariodev.server
import mariodev.util.Constants.MAX_ROOM_SIZE
    ...
    route("/api/createRoom") {
        post {
            ...
            if (roomRequest.maxPlayers < 2) {
                call.respond(HttpStatusCode.OK, BasicApiResponse(false, "The minimum room size is 2."))
                return@post
            }
            if (roomRequest.maxPlayers > MAX_ROOM_SIZE) {
                call.respond(HttpStatusCode.OK, BasicApiResponse(false, "The maximum room size is $MAX_ROOM_SIZE"))
                return@post
            }
